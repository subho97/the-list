  ...
  return (
    <div className="min-h-screen pt-24 px-4 flex items-center justify-center">
      <div className="text-center max-w-sm">
        ...
        <h2 className="font-serif text-xl font-bold text-stone-900 mb-2">Browse failed to load</h2>
        <p className="text-sm text-olive mb-6">Could not load the browse page. It might be a temporary issue.</p>
